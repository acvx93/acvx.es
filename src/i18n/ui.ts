...
export const UI = {
  es: {
    ...
    navSobre: 'Sobre mí',
    navEnsayos: 'Ensayos',
    temaAutomatico: 'Tema automático (según el sistema). Activar modo claro',
    temaClaro: 'Tema claro. Activar modo oscuro',
    temaOscuro: 'Tema oscuro. Activar modo automático',
  ...
  en: {
    ...
    navSobre: 'About',
    navEnsayos: 'Essays',
    temaAutomatico: 'Automatic theme (system setting). Switch to light mode',
    temaClaro: 'Light theme. Switch to dark mode',
    temaOscuro: 'Dark theme. Switch to automatic mode',
